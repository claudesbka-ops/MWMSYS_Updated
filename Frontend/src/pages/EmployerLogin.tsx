...
export default function EmployerLogin() {
  ...
  return (
    <AuthLayout title="Employer Sign in" subtitle="Login with your Employer credentials">
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          <Button type="button" variant="outline" className="flex-1" onClick={() => navigate("/signup/employer")}>
            Employer Sign Up
          </Button>
