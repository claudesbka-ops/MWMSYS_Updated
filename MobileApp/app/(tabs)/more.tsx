...
const TOOLS: Tool[] = [
  ...
  { key: "disputes", title: "Salary disputes", description: "Submit and review disputes", icon: "balance-scale", gradient: ["#f59e0b", "#ef4444"], href: "/disputes", roles: ["worker", "employer", "agency"] },
  { key: "roster", title: "Roster", description: "Shift templates and assignments", icon: "calendar-o", gradient: ["#6366f1", "#ec4899"], href: "/roster", roles: ["employer", "agency"] },
  ...
  { key: "incidents", title: "Incidents", description: "Review incident reports", icon: "warning", gradient: ["#ef4444", "#f97316"], href: "/(tabs)/incidents", roles: ["employer", "agency"] },
  ...
  { key: "live-map", title: "Live map", description: "Real-time worker locations", icon: "map-marker", gradient: ["#ec4899", "#6366f1"], href: "/(tabs)/live-map", roles: ["employer", "agency"] },
  { key: "attestation", title: "Attestation", description: "Attest incident reports", icon: "check-square", gradient: ["#10b981", "#0ea5e9"], href: "/(tabs)/attestation", roles: ["agency"] },
  { key: "reports", title: "Reports", description: "Entry, visa, insurance and HRMS summary", icon: "bar-chart", gradient: ["#6366f1", "#0ea5e9"], href: "/(tabs)/reports", roles: ["employer", "agency"] },
  ...
  { key: "settings", title: "Settings", description: "Preferences and location", icon: "cog", gradient: ["#64748b", "#0f172a"], href: "/(tabs)/settings", roles: ["*"] },
];
