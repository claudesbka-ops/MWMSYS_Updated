  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <TextInput value={address} onChangeText={setAddress} style={[styles.input, styles.multiline]} multiline />

        <Text style={[styles.label, { marginTop: 12 }]}>Phone</Text>
        <TextInput value={phone} onChangeText={setPhone} style={styles.input} autoCapitalize="none" />

        <Text style={[styles.label, { marginTop: 12 }]}>SSM / License No (optional)</Text>
        <TextInput value={ssmNumber} onChangeText={setSsmNumber} style={styles.input} autoCapitalize="none" />
