 ...
 */
export async function ensureSubscriptionTableExists(): Promise<void> {
  try {
 ...
 */
export async function hasActivePlan(entityId: string): Promise<boolean> {
 ...
 */
export function requireActivePlanForWrite(req: Request, res: Response, next: NextFunction) {
